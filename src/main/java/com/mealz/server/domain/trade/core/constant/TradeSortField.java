...
@Getter
@AllArgsConstructor
public enum TradeSortField implements SortField {
   ...
   */
  @JsonCreator
  public static TradeSortField from(String value) {
    return CommonUtil.stringToSortField(TradeSortField.class, value);
  }
}
