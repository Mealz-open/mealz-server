package com.mealz.server.domain.storage.application.service;
...
import com.mealz.server.domain.storage.core.constant.FileExtension;
...
import com.mealz.server.domain.storage.infrastructure.properties.S3Properties;
...
public class S3Service implements StorageService {
  ...
  private String determinePrefix(UploadType type) {
    return switch (type) {
      ...
      case SHOP -> s3Properties.s3().path().shop();
      case ITEM -> s3Properties.s3().path().item();
    };
  }
