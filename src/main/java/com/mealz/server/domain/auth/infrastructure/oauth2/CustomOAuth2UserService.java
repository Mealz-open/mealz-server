package com.mealz.server.domain.auth.infrastructure.oauth2;

import com.mealz.server.domain.auth.core.response.OAuth2Response;
import com.mealz.server.domain.auth.infrastructure.oauth2.response.KakaoResponse;
import com.mealz.server.domain.auth.infrastructure.oauth2.response.NaverResponse;
