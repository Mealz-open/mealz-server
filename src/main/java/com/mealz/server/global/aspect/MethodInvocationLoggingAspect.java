package com.mealz.server.global.aspect;
...
public class MethodInvocationLoggingAspect {
   ...
   */
  @Around("@annotation(com.mealz.server.global.annotation.LogMethodInvocation) || @annotation(com.mealz.server.global.annotation.LogMonitoringInvocation)")
